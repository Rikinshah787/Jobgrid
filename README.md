...
| Feature | Description |
|---------|-------------|
| ✨ **Magic Search** | One query searches all platforms simultaneously |
| 📺 **Split-Screen View** | Compare 2-4 job boards side by side |
| ⏰ **Time Filter** | Past hour, 24 hours, week, or month |
| 💼 **Job Type Filter** | Full-time, part-time, contract, remote |
| 📍 **Location Filter** | City, state, or fully remote |
| 🚀 **One-Click Launch** | All platforms open with your query pre-filled |
